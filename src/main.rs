...
fn patch_files_with_docs(results: &[LlmDocResult], overwrite: bool) -> Result<()> {
    ...
    /// Examples:
    /// ```rust
    /// assert_eq!(field_doc_insertion_range("///Example", 2, true), Some((0, 2)));
    /// assert_eq!(field_doc_insertion_range("///Another Example", 4, true), Some((0, 2)));
    ...
    /// assert_eq!(indented_doc, "    /// Hello, world! This is a test.");
    /// ```
